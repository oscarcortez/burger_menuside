  ...
  return (
    <div className="flex flex-col md:flex-row h-screen relative">
      <div className="md:w-1/3 p-4 relative border">
        <button className="absolute top-0 right-0" onClick={() => setSidebar1Open(!sidebar1Open)}>
          Abrir Sidebar
        </button>
        {sidebar1Open && <div className="fixed inset-0 bg-gray-500 bg-opacity-50 z-10"></div>}
        <div
      ...
      <div className="md:w-1/3 p-4 relative border">
        <button className="absolute top-0 right-0" onClick={() => setSidebar2Open(!sidebar2Open)}>
          Abrir Sidebar
        </button>
        {sidebar2Open && <div className="fixed inset-0 bg-gray-500 bg-opacity-50 z-10"></div>}
        <div
      ...
      <div className="md:w-1/3 p-4 relative border">
        <button className="absolute top-0 right-0" onClick={() => setSidebar3Open(!sidebar3Open)}>
          Abrir Sidebar
        </button>
        {sidebar3Open && <div className="fixed inset-0 bg-gray-500 bg-opacity-50 z-10"></div>}
        <div
